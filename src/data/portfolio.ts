...
export const portfolioContent: PortfolioContent = {
    hero: {
        ...
        images: [
            { src: '/images/crafted.png', alt: 'A crafted tablescape at The Reserve' },
            { src: '/images/where-section-bg.png', alt: 'The Reserve ballroom' },
            { src: '/images/insta-sec-1.png', alt: 'A celebration at The Reserve' },
        ],
    },
    slides: [
        {
